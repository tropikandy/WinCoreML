...
class InvalidArgumentError(ClientError):
    ...
    def __init__(
        self, message: str = "Invalid argument provided", details: Optional[str] = None
    ):
...
class InvalidModelIdError(ClientError):
    ...
    def __init__(
        self, message: str = "Invalid model ID", details: Optional[str] = None
    ):
...
class InvalidInputShapeError(ClientError):
    ...
    def __init__(
        self, message: str = "Invalid input tensor shape", details: Optional[str] = None
    ):
...
class InvalidInputTypeError(ClientError):
    ...
    def __init__(
        self, message: str = "Invalid input tensor type", details: Optional[str] = None
    ):
...
class InvalidConfigError(ClientError):
    ...
    def __init__(
        self, message: str = "Invalid configuration", details: Optional[str] = None
    ):
...
class MissingRequiredInputError(ClientError):
    ...
    def __init__(
        self, message: str = "Missing required input", details: Optional[str] = None
    ):
...
class UnsupportedFeatureError(ClientError):
    ...
    def __init__(
        self, message: str = "Unsupported feature", details: Optional[str] = None
    ):
...
class ModelLoadFailedError(ModelError):
    ...
    def __init__(
        self, message: str = "Failed to load model", details: Optional[str] = None
    ):
...
class ModelParseFailedError(ModelError):
    ...
    def __init__(
        self, message: str = "Failed to parse model", details: Optional[str] = None
    ):
...
class ModelValidationFailedError(ModelError):
    ...
    def __init__(
        self, message: str = "Model validation failed", details: Optional[str] = None
    ):
...
class UnsupportedModelVersionError(ModelError):
    ...
    def __init__(
        self, message: str = "Unsupported model version", details: Optional[str] = None
    ):
...
class UnsupportedOperationError(ModelError):
    ...
    def __init__(
        self,
        message: str = "Model contains unsupported operations",
...
class ModelConversionFailedError(ModelError):
    ...
    def __init__(
        self, message: str = "Model conversion failed", details: Optional[str] = None
    ):
...
class ModelCorruptedError(ModelError):
    ...
    def __init__(
        self, message: str = "Model file is corrupted", details: Optional[str] = None
    ):
...
class ModelTooLargeError(ModelError):
    ...
    def __init__(
        self, message: str = "Model exceeds size limits", details: Optional[str] = None
    ):
...
class ProviderNotAvailableError(ProviderError):
    ...
    def __init__(
        self,
        message: str = "Requested provider is not available",
        details: Optional[str] = None,
    ):
...
class ProviderInitFailedError(ProviderError):
    ...
    def __init__(
        self,
        message: str = "Provider initialization failed",
        details: Optional[str] = None,
    ):
...
class ProviderExecutionFailedError(ProviderError):
    ...
    def __init__(
        self, message: str = "Provider execution failed", details: Optional[str] = None
    ):
...
class DeviceNotFoundError(ProviderError):
    ...
    def __init__(
        self, message: str = "Compute device not found", details: Optional[str] = None
    ):
...
class DeviceLostError(ProviderError):
    ...
    def __init__(
        self, message: str = "Compute device was lost", details: Optional[str] = None
    ):
...
class DriverError(ProviderError):
    ...
    def __init__(
        self, message: str = "Device driver error", details: Optional[str] = None
    ):
...
class OutOfDeviceMemoryError(ProviderError):
    ...
    def __init__(
        self, message: str = "Out of device memory", details: Optional[str] = None
    ):
...
class UnsupportedHardwareError(ProviderError):
    ...
    def __init__(
        self, message: str = "Hardware is not supported", details: Optional[str] = None
    ):
...
class ProviderNotCompatibleError(ProviderError):
    ...
    def __init__(
        self,
        message: str = "Provider is not compatible with model",
        details: Optional[str] = None,
    ):
...
class ProviderTimeoutError(ProviderError):
    ...
    def __init__(
        self, message: str = "Provider execution timeout", details: Optional[str] = None
    ):
...
class InternalError(RuntimeError):
    ...
    def __init__(
        self, message: str = "Internal runtime error", details: Optional[str] = None
    ):
...
class NotImplementedError(RuntimeError):
    ...
    def __init__(
        self, message: str = "Feature not implemented", details: Optional[str] = None
    ):
...
class IPCFailedError(RuntimeError):
    ...
    def __init__(
        self, message: str = "IPC communication failed", details: Optional[str] = None
    ):
...
class CacheWriteFailedError(RuntimeError):
    ...
    def __init__(
        self, message: str = "Failed to write to cache", details: Optional[str] = None
    ):
...
class RegistryError(RuntimeError):
    ...
    def __init__(
        self, message: str = "Model registry error", details: Optional[str] = None
    ):
...
class UnsupportedPlatformError(RuntimeError):
    ...
    def __init__(
        self, message: str = "Platform not supported", details: Optional[str] = None
    ):
...
class TimeoutError(TransientError):
    ...
    def __init__(
        self, message: str = "Operation timed out", details: Optional[str] = None
    ):
...
class ResourceBusyError(TransientError):
    ...
    def __init__(
        self, message: str = "Resource is busy", details: Optional[str] = None
    ):
...
class ResourceExhaustedError(TransientError):
    ...
    def __init__(
        self, message: str = "Resource exhausted", details: Optional[str] = None
    ):
...
class OperationCancelledError(TransientError):
    ...
    def __init__(
        self, message: str = "Operation was cancelled", details: Optional[str] = None
    ):
...
class TemporaryFailureError(TransientError):
    ...
    def __init__(
        self,
        message: str = "Temporary failure, retry recommended",
        details: Optional[str] = None,
    ):
...
class RateLimitedError(TransientError):
    ...
    def __init__(
        self, message: str = "Rate limit exceeded", details: Optional[str] = None
    ):
